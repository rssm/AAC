//
//  DireitodeAmarPlayerViewController.swift
//  ApoieACena
//
...
class DireitodeAmarPlayerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        do{
            let audioPath = Bundle.main.path(forResource: "Zebu - Direito de te amar cover Belo ft Talento", ofType: "mp3")
