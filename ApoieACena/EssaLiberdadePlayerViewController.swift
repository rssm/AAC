//
//  EssaLiberdadeViewController.swift
//  ApoieACena
//
//  Created by Clara Carneiro on 12/04/17.
...
class EssaLiberdadePlayerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        do{
            let audioPath = Bundle.main.path(forResource: "Zebu - Essa Tal Liberdade SPC Cover Remix ft Phillip Nutt", ofType: "mp3")
